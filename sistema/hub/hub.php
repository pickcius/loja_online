...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-custom">
        <div class="container-fluid">
            <a class="navbar-brand" href="<?php echo HUB_URL; ?>hub.php">🛍️ Loja Online</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo CARRINHO_URL; ?>carrinho.php" style="position: relative;">
                            🛒 Carrinho
    ...
    <div class="container">
        <div class="search-container">
            <form method="GET" action="<?php echo HUB_URL; ?>hub.php" class="search-box">
                <input 
                    type="text" 
                    class="search-input" 
                    name="busca" 
        ...
        <div class="filter-container">
            <form method="GET" action="hub.php" class="row g-3">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <a href="<?php echo HUB_URL; ?>hub.php" class="btn btn-secondary w-100">Limpar Filtros</a>
                </div>
            </form>
        </div>
                            ...
                            <div class="product-body">
                                ...
                                <div class="product-footer" style="margin-top: auto; flex-direction: column; gap: 10px;">
                                    ...
                                    <?php if ($produto['quantidade_disponivel'] > 0): ?>
                                        <form method="POST" action="../carrinho/carrinho.php" style="width: 100%;">
