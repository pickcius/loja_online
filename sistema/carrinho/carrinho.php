...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo HUB_URL; ?>hub.php">← Voltar para Loja</a>
                    </li>
                    <li class="nav-item">
                        <div class="user-info">
    ...
    <div class="container-carrinho">
        ...
        <div class="breadcrumb-custom">
            <span>🏠 <a href="<?php echo HUB_URL; ?>hub.php" style="color: #667eea; text-decoration: none;">Loja</a></span>
            <span> / 🛒 Carrinho</span>
        </div>
        ...
        <?php else: ?>
            ...
            <div class="card-carrinho">
                <div class="empty-cart">
                    ...
                    <a href="<?php echo HUB_URL; ?>hub.php" class="btn btn-primary" style="margin-top: 20px;">
                        ← Continuar Comprando
                    </a>
                </div>
            </div>
