...
<div class="container my-5">
    ...
    $stmt = $pdo->query($sql);
    $dado = $stmt->fetch(PDO::FETCH_ASSOC);
    echo "<p><strong>Média Geral:</strong> R$ " . number_format($dado['Media_Geral_Produtos'], 2, ',', '.') . "</p>";
    ?>
    ...
    $stmt = $pdo->query($sql);
    $dado = $stmt->fetch(PDO::FETCH_ASSOC);
    echo "<p><strong>Média com desconto:</strong> R$ " . number_format($dado['Media_Precos_Com_Desconto'], 2, ',', '.') . "</p>";
    ?>
